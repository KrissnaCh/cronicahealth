...
from database.models import AntecedentesFamiliares, AntecedentesPersonales, ExamenFisico, ExamenFisicoPorSistemas, InformacionGeneralPaciente, PlanManejo, Seguimiento
